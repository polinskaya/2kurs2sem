...
'ПРИМЕЧАНИЕ. Во время обновления пространств имен в проекте добавьте новый или обновите существующий атрибут XmlnsDefinitionAttribute
'Можно добавить дополнительные атрибуты для сопоставления любых дополнительных пространств имен в проекте
