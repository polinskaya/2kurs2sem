    ...
    Protected Sub Page_Load() Handles Me.Load
        If Not IsPostBack Then
            ...
            If message IsNot Nothing Then
                ...
                SuccessMessageText = If(message = "ChangePwdSuccess", "Ваш пароль изменен.", If(message = "SetPwdSuccess", "Пароль задан.", If(message = "RemoveLoginSuccess", "Учетная запись удалена.", [String].Empty)))
