<%@ Page Title="Управление учетной записью" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Manage.aspx.vb" Inherits="Account_Manage" %>
            ...
            <section id="passwordForm">
                ...
                <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <asp:Button runat="server" Text="Изменить пароль" OnClick="ChangePassword_Click" CssClass="btn btn-default" ValidationGroup="ChangePassword" />
                            </div>
                        </div>
                    </div>
                </asp:PlaceHolder>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button runat="server" Text="Удалить" CommandName="Delete" CausesValidation="false"
                                    ToolTip='<%# "Удалите это " + Item.LoginProvider + " имя входа из вашей учетной записи" %>'
