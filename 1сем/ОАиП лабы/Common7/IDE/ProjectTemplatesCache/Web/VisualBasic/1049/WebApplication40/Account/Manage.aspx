<%@ Page Title="Управление учетной записью" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Manage.aspx.vb" Inherits="Account_Manage" %>
        ...
        $endif$
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <asp:Button runat="server" Text="Удалить" CommandName="Delete" CausesValidation="false" 
                            ToolTip='<%# "Удалите эту учетную запись " & Item(Of OpenAuthAccountData)().ProviderDisplayName & " у себя" %>'
                            Visible="<%# CanRemoveExternalLogins %>" />
                    </td>
                    $endif$
                </tr>
