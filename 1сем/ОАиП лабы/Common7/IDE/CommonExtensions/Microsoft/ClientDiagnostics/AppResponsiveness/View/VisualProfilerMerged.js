...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/js/TimestampConvertor.js.map
...
<div class=\"filteringBar\">\
            <div id=\"timelineSort\" class=\"timelineSort\">\
                ...
                <div data-name=\"timelineSortSelector\" data-control=\"Common.Controls.ComboBox\" data-binding=\"items:sortOptions,                                    selectedValue:sort; mode=twoway; converter=Common.CommonConverters.IntToStringConverter\" data-options=\"className:timelineSortSelector\"></div>\
            </div>\
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/_external/VisualProfiler.templates.js.map

// GlobalRuler.ts
// 
// Copyright (C) Microsoft. All rights reserved.
//
/// <reference path="../../../DiagnosticsHub/inc/DiagnosticsHub.d.ts" />
/// <reference path="../../../DiagnosticsHub/inc/Controls.d.ts" />
/// <reference path="../Program.ts" />
/// <reference path="TimeSpan.ts" />
/// <reference path="../../Common/Notifications.ts" />
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/js/GlobalRuler.js.map
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/js/extensions/userSettings.js.map
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/js/TimeSpan.js.map
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/js/DragDirection.js.map
            ...
            if (sectBaseData.length === 1) {
                ...
                for (i = 0; i < sectBaseData.length - 1; i++) {
                    ...
                    sectDonutData.push({
                        ...
                        endAngle: currAngle + arcAngle - this._config.explosionFactor,
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/js/controls/DonutChart.js.map
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/js/FormattingHelpers.js.map
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/js/controls/Divider.js.map
...
(function (VisualProfiler) {
    ...
    var EventDataTemplate = (function (_super) {
        ...
        EventDataTemplate.viewSource = function (unshortenedUrl, line, column) {
            Microsoft.Plugin.Host.showDocument(unshortenedUrl, line, column).done(function () {
            }, function (err) {
                VisualProfiler.Program.hostShell.setStatusBarText(Microsoft.Plugin.Resources.getString("UnableToNavigateToSource"), true);
            });
        };
    ...
    var EventsTimelineListControl = (function (_super) {
        ...
        EventsTimelineListControl.prototype.onShowContextMenu = function () {
            var _this = this;
            this.getSelectedItemContainer().done(function (selectedItemContainer) {
        ...
        EventsTimelineListControl.prototype.getSelectionContextMenuIconNames = function () {
            if (VisualProfiler.Program.hostType === 0 /* VS */) {
                return {
                    zoomin: {
        ...
        EventsTimelineListControl.prototype.filterToEvent = function () {
            ...
            this.getSelectedItemContainer().done(function (selectedItemContainer) {
                if (selectedItemContainer) {
                    selectedItemContainer.template.expand().done(function () {
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/js/EventsTimelineListControl.js.map
...
(function (VisualProfiler) {
    ...
    var ProfilerEvent = (function () {
        ...
        ProfilerEvent.prototype.getBarCssClass = function () {
            switch (this._category) {
                case 7 /* XamlFrameNavigation */:
                case 5 /* AppStartup */:
                case 4 /* WindowResized */:
                    return "bracket";
                default:
                    return null;
            }
        ...
        ProfilerEvent.prototype.getCssClass = function () {
            switch (this._category) {
                ...
                case 9 /* XamlLayout */:
                    return "dataLayout";
                case 11 /* XamlUIElementCost */:
                    return "dataUIElementCost";
                case 12 /* XamlUIThreadFrame */:
    ...
    var GarbageCollectionEvent = (function (_super) {
        ...
        GarbageCollectionEvent.prototype.getDetails = function () {
            ...
            var gcInterval = this.interval;
            result.push(this.createDetailInfo("Reason", this.getGCReasonString(gcInterval.reason), "GarbageCollectionIntervalReason", null));
            result.push(this.createDetailInfo("Count", gcInterval.count, "GarbageCollectionIntervalCount", null));
            result.push(this.createDetailInfo("Type", this.getGCTypeString(gcInterval.type), "GarbageCollectionIntervalType", null));
            result.push(this.createDetailInfo("Generation", gcInterval.generation, "GarbageCollectionIntervalGeneration", null));
            return result;
        };
    ...
    var LayoutEvent = (function (_super) {
        ...
        LayoutEvent.prototype.getDetails = function () {
            var result = _super.prototype.getDetails.call(this);
            var layoutInterval = this.interval;
            result.push(this.createDetailInfo("ElementCount", layoutInterval.elementCount, "LayoutIntervalElementCount", null));
            return result;
        };
    ...
    var NetworkEvent = (function (_super) {
        ...
        NetworkEvent.prototype.isValidImageUrl = function (url) {
            ...
            var networkInterval = this.interval;
            return VisualProfiler.ImageUrlValidationHelpers.IMG_URL_REGEX.test(url) || (VisualProfiler.ImageUrlValidationHelpers.HTTP_URL_REGEX.test(url) && (networkInterval.mimeType === "" || VisualProfiler.ImageUrlValidationHelpers.IMG_URL_CONTENTTYPE_REGEX.test(networkInterval.mimeType)));
        };
        ...
        NetworkEvent.prototype.getDetails = function () {
            var result = _super.prototype.getDetails.call(this);
            var networkInterval = this.interval;
            result.push(this.createDetailInfo("Url", networkInterval.url, "NetworkIntervalUrl", null));
            result.push(this.createDetailInfo("Method", networkInterval.method, "NetworkIntervalMethod", null));
            result.push(this.createDetailInfo("StatusCode", Microsoft.Plugin.Resources.getString("NetworkIntervalStatusCodeValue", networkInterval.statusCode, networkInterval.statusText), "NetworkIntervalStatusCode", null));
            result.push(this.createDetailInfo("SentBytes", VisualProfiler.FormattingHelpers.getPrettyPrintBytes(networkInterval.sentBytes), "NetworkIntervalSentBytes", null));
            result.push(this.createDetailInfo("ReceivedBytes", VisualProfiler.FormattingHelpers.getPrettyPrintBytes(networkInterval.receivedBytes), "NetworkIntervalReceivedBytes", null));
            result.push(this.createDetailInfo("ContentType", networkInterval.mimeType, "NetworkIntervalContentType", null));
            return result;
        };
    ...
    var DiskIOEvent = (function (_super) {
        ...
        DiskIOEvent.prototype.getDetails = function () {
            var result = _super.prototype.getDetails.call(this);
            var diskIoInterval = this.interval;
            result.push(this.createDetailInfo("Operation", this._operation, "DiskIOIntervalOperation", null));
            result.push(this.createDetailInfo("FileName", diskIoInterval.fileName, "DiskIOIntervalFileName", null));
            result.push(this.createDetailInfo("Path", diskIoInterval.path, "DiskIOIntervalPath", null));
            result.push(this.createDetailInfo("Size", this._formattedTotalBytes, "DiskIOIntervalSize", null));
            return result;
        };
    ...
    var UIElementCostEvent = (function (_super) {
        ...
        UIElementCostEvent.prototype.getDetails = function () {
            var result = _super.prototype.getDetails.call(this);
            var elementInterval = this.interval;
            result.push(this.createDetailInfo("Class", elementInterval.className, "UIElementCostClass", null));
            if (elementInterval.elementName) {
                result.push(this.createDetailInfo("Name", elementInterval.elementName, "UIElementCostName", null));
            }
            if (elementInterval.templateName || elementInterval.templateType) {
                result.push(this.createDetailInfo("TemplateName", this.getTemplateName(elementInterval), "UIElementCostTemplateName", null));
            }
            result.push(this.createDetailInfo("Count", elementInterval.childrenCount, "UIElementCostCount", null));
            return result;
        };
    ...
    var VisualStateChangedEvent = (function (_super) {
        ...
        VisualStateChangedEvent.prototype.getDetails = function () {
            ...
            if (visualStateChangedInterval.elementName) {
                result.push(this.createDetailInfo("Element", visualStateChangedInterval.elementName, "VisualStateChangedElementLabel", null));
            }
            result.push(this.createDetailInfo("Type", visualStateChangedInterval.className, "VisualStateChangedTypeLabel", null));
            result.push(this.createDetailInfo("State", visualStateChangedInterval.state, "VisualStateChangedStateLabel", null));
            return result;
        };
    ...
    var FrameNavigationEvent = (function (_super) {
        ...
        FrameNavigationEvent.prototype.getDetails = function () {
            var result = _super.prototype.getDetails.call(this);
            var frameNavigationInterval = this.interval;
            result.push(this.createDetailInfo("Class", frameNavigationInterval.className, "FrameNavigationEventClass", null));
            result.push(this.createDetailInfo("NavigationMode", this.getNavigationModeString(frameNavigationInterval.navigationMode), "FrameNavigationEventNavigationModeLabel", null));
    ...
    var ParsingEvent = (function (_super) {
        ...
        ParsingEvent.prototype.getDetails = function () {
            ...
            if (parsingInterval.parsingFromString) {
                ...
                result.push(this.createDetailInfo("FileName", parsingInterval.fileName, "ParsingIntervalFileName", null));
                result.push(this.createDetailInfo("Path", parsingInterval.path, "ParsingIntervalPath", null));
            }
            result.push(this.createDetailInfo("InclusiveCount", parsingInterval.inclusiveElements, "ParsingIntervalInclusiveCount", null));
            result.push(this.createDetailInfo("ExclusiveCount", parsingInterval.exclusiveElements, "ParsingIntervalExclusiveCount", null));
            return result;
        };
    ...
    var EventsTimelineDataSource = (function () {
        ...
        EventsTimelineDataSource.prototype.initialize = function (queryResult) {
            ...
            this._initializePromise = this._queryResult.getIntervalsCount().then(function (eventsCount) {
        ...
        EventsTimelineDataSource.prototype.collapseBranch = function (index) {
            var _this = this;
            return this._queryResult.collapseIntervalBranch(index).then(function () {
                return _this.resetData();
            });
        };
        EventsTimelineDataSource.prototype.expandBranch = function (index) {
            var _this = this;
            return this._queryResult.expandIntervalBranch(index).then(function () {
                return _this.resetData();
            });
        };
        ...
        EventsTimelineDataSource.prototype.expandFrameForEvent = function (eventId) {
            var _this = this;
            return this._queryResult.expandFrameForEvent(eventId).then(function () {
                return _this.resetData();
            });
        };
        ...
        EventsTimelineDataSource.prototype.startAt = function (index) {
            if (this._currentIndex !== null) {
                throw new Error(Microsoft.Plugin.Resources.getErrorString("JSPerf.1058"));
            }
        ...
        EventsTimelineDataSource.prototype.fetchData = function (index, max) {
            ...
            return this._queryResult.getIntervals(fromIndex, toIndex).then(function (intervals) {
        ...
        EventsTimelineDataSource.prototype.resetData = function () {
            ...
            this._dataPrevious = [];
            this._data = [];
            return this._queryResult.getIntervalsCount().then(function (count) {
                _this._count = count;
            });
        };
    ...
    var EventsTimelineModel = (function () {
        ...
        EventsTimelineModel.prototype.getEvents = function (timeSpan, filter) {
            var _this = this;
            return this._session.queryAppIntervals(timeSpan, filter).then(function (intervalsQuery) {
                ...
                return dataSource.initialize(intervalsQuery).then(function () {
                    return dataSource;
                });
            });
        };
        EventsTimelineModel.prototype.getTelemetryStatsAndFormatForReporting = function () {
            return this._session.getTelemetryStats().then(function (telemetryStats) {
                var durations = {};
    ...
    var EventsTimelineViewModel = (function (_super) {
        ...
        function EventsTimelineViewModel(model, globalRuler, markEventModel) {
            ...
            this.sort = 0 /* ChronographicalSort */;
        ...
        EventsTimelineViewModel.prototype.setSelectedEvent = function (event) {
            ...
            if (this._selectedEvent !== event) {
                ...
                if (this.selectedEventChanged) {
                    ...
                    return this.selectedEventChanged(this._selectedEvent).then(function () {
        ...
        EventsTimelineViewModel.initialize = function () {
            Common.ObservableHelpers.defineProperty(EventsTimelineViewModel, EventsTimelineViewModel.DisplayBackgroundActivitiesPropertyName, false, function (obj) { return obj.onFilterChange(); }, function (obj) { return obj.onFilterChanging(); });
            Common.ObservableHelpers.defineProperty(EventsTimelineViewModel, EventsTimelineViewModel.DisplayFramesPropertyName, false, function (obj) { return obj.onFilterChange(); }, function (obj) { return obj.onFilterChanging(); });
            Common.ObservableHelpers.defineProperty(EventsTimelineViewModel, EventsTimelineViewModel.DisplayScenariosPropertyName, true, function (obj) { return obj.onFilterChange(); }, function (obj) { return obj.onFilterChanging(); });
            Common.ObservableHelpers.defineProperty(EventsTimelineViewModel, EventsTimelineViewModel.DisplayIOActivitiesPropertyName, true, function (obj) { return obj.onFilterChange(); }, function (obj) { return obj.onFilterChanging(); });
            Common.ObservableHelpers.defineProperty(EventsTimelineViewModel, EventsTimelineViewModel.DisplayUIActivitiesPropertyName, true, function (obj) { return obj.onFilterChange(); }, function (obj) { return obj.onFilterChanging(); });
            Common.ObservableHelpers.defineProperty(EventsTimelineViewModel, EventsTimelineViewModel.DurationFilterPropertyName, 0, function (obj) { return obj.onFilterChange(); }, function (obj) { return obj.onFilterChanging(); });
            Common.ObservableHelpers.defineProperty(EventsTimelineViewModel, EventsTimelineViewModel.EventNameFilterPropertyName, "", function (obj) { return obj.onFilterChange(); }, function (obj) { return obj.onFilterChanging(); });
            Common.ObservableHelpers.defineProperty(EventsTimelineViewModel, EventsTimelineViewModel.EventTypeFilterPropertyName, "", function (obj) { return obj.onFilterChange(); }, function (obj) { return obj.onFilterChanging(); });
            Common.ObservableHelpers.defineProperty(EventsTimelineViewModel, EventsTimelineViewModel.HasFilterSettingsChangedPropertyName, true, null, null);
            Common.ObservableHelpers.defineProperty(EventsTimelineViewModel, EventsTimelineViewModel.HasViewSettingsChangedPropertyName, true, null, null);
            Common.ObservableHelpers.defineProperty(EventsTimelineViewModel, EventsTimelineViewModel.ShowDurationSelfInTimelinePropertyName, true, function (obj) { return obj.onViewSettingsChange(); }, null);
            Common.ObservableHelpers.defineProperty(EventsTimelineViewModel, EventsTimelineViewModel.ShowHintTextInTimelinePropertyName, true, function (obj) { return obj.onViewSettingsChange(); }, null);
            Common.ObservableHelpers.defineProperty(EventsTimelineViewModel, EventsTimelineViewModel.ShowQualifiersInEventNamesPropertyName, true, function (obj) { return obj.onViewSettingsChange(); }, null);
            Common.ObservableHelpers.defineProperty(EventsTimelineViewModel, EventsTimelineViewModel.ShowThreadIndicatorPropertyName, true, function (obj) { return obj.onViewSettingsChange(); }, null);
            Common.ObservableHelpers.defineProperty(EventsTimelineViewModel, EventsTimelineViewModel.SortPropertyName, 0, function (obj) { return obj.onFilterChange(); }, function (obj) { return obj.onFilterChanging(); });
        };
        ...
        EventsTimelineViewModel.prototype.getEvents = function () {
            ...
            if (this._isDataSourceInvalid) {
                var filter = {
                    ...
                    sortByTime: this.sort === 0 /* ChronographicalSort */,
                };
                this._gettingEventsPromise = this._model.getEvents(this._timeSpan, filter).then(function (dataSource) {
                    ...
                    if (_this.displayFrames && _this._selectedEvent) {
                        _this._dataSource.expandFrameForEvent(_this._selectedEvent.id).done(function () {
        ...
        EventsTimelineViewModel.prototype.onFilterChange = function () {
            this.hasDefaultFilter = this.displayBackgroundActivities === true && this.displayScenarios === true && this.displayIOActivities === true && this.displayUIActivities === true && (!this.durationFilter || this.durationFilter === 0) && (!this.eventNameFilter || this.eventNameFilter.length === 0) && (!this.eventTypeFilter || this.eventTypeFilter.length === 0);
        ...
        EventsTimelineViewModel.prototype.onViewSettingsChange = function () {
            this.hasViewSettingsChanged = !this.showDurationSelfInTimeline || !this.showHintTextInTimeline || !this.showQualifiersInEventNames || !this.showThreadIndicator;
        };
    ...
    var EventsTimelineView = (function (_super) {
        ...
        EventsTimelineView.prototype.render = function () {
            ...
            if (this._viewModel) {
                ...
                this._renderPromise = this._viewModel.getEvents().then(function (dataSource) {
        ...
        EventsTimelineView.prototype.createRuler = function () {
            ...
            this._rulerScale = new DiagnosticsHub.RulerScale(this._viewModel.timeSpan.toJsonTimespan());
            ...
            this._gettingMarksPromise = Microsoft.Plugin.Promise.join([lifecycleMarksPromise, userMarksPromise]).then(function () {
                ...
                // Extend the timeSpan to act as padding so the text to the right of the event bars are always visible.
                var timeSpan = new VisualProfiler.TimeSpan(_this._viewModel.timeSpan.begin, new VisualProfiler.TimeStamp(_this._viewModel.timeSpan.end.nsec + _this._viewModel.timeSpan.elapsed.nsec * _this._timeSpanPadding));
                _this._rulerScale = new DiagnosticsHub.RulerScale(timeSpan.toJsonTimespan(), [
                    { index: 0, id: 2 /* UserMark */, label: Microsoft.Plugin.Resources.getString("RulerUserMarkLabel"), data: userMarkData },
                    { index: 1, id: 1 /* LifeCycleEvent */, label: Microsoft.Plugin.Resources.getString("RulerLifecycleMarkLabel"), data: lifecycleData }
                ], ["vs-image-graph-app-event", "vs-image-graph-user-mark"], "vs-image-graph-aggregated-event");
        ...
        EventsTimelineView.prototype.onViewModelPropertyChanged = function (propName) {
            switch (propName) {
                case EventsTimelineViewModel.ShowDurationSelfInTimelinePropertyName:
                    {
                        this.onViewSettingsChange(121 /* Timeline_GridUpdatedForShowDuration_Start */, 122 /* Timeline_GridUpdatedForShowDuration_Stop */);
                ...
                case EventsTimelineViewModel.ShowHintTextInTimelinePropertyName:
                    {
                        this.onViewSettingsChange(125 /* Timeline_GridUpdatedForShowHintText_Start */, 126 /* Timeline_GridUpdatedForShowHintText_Stop */);
                ...
                case EventsTimelineViewModel.ShowQualifiersInEventNamesPropertyName:
                    {
                        this.onViewSettingsChange(123 /* Timeline_GridUpdatedForShowQualifiers_Start */, 124 /* Timeline_GridUpdatedForShowQualifiers_Stop */);
                ...
                case EventsTimelineViewModel.ShowThreadIndicatorPropertyName:
                    {
                        this.onViewSettingsChange(127 /* Timeline_GridUpdatedForShowThreadIndicator_Start */, 128 /* Timeline_GridUpdatedForShowThreadIndicator_Stop */);
                ...
                case EventsTimelineViewModel.DisplayScenariosPropertyName:
                    {
                        this.onToggleFilter(115 /* Timeline_GridUpdatedForFilterScenarios_Start */, 116 /* Timeline_GridUpdatedForFilterScenarios_Stop */);
                ...
                case EventsTimelineViewModel.DisplayIOActivitiesPropertyName:
                    {
                        this.onToggleFilter(113 /* Timeline_GridUpdatedForFilterIO_Start */, 114 /* Timeline_GridUpdatedForFilterIO_Stop */);
                ...
                case EventsTimelineViewModel.DisplayUIActivitiesPropertyName:
                    {
                        this.onToggleFilter(129 /* Timeline_GridUpdatedForFilterUI_Start */, 130 /* Timeline_GridUpdatedForFilterUI_Stop */);
                ...
                case EventsTimelineViewModel.DurationFilterPropertyName:
                    {
                        this.onToggleFilter(131 /* Timeline_GridUpdatedForFilterDuration_Start */, 132 /* Timeline_GridUpdatedForFilterDuration_Stop */);
                ...
                case EventsTimelineViewModel.EventTypeFilterPropertyName:
                    {
                        this.onToggleFilter(133 /* Timeline_GridUpdatedForFilterType_Start */, 134 /* Timeline_GridUpdatedForFilterType_Stop */);
        ...
        EventsTimelineView.prototype.onViewModelSelectionChanged = function (event) {
            ...
            this._viewModelSelectionChangedPromise = this._listControl.setSelectedItem(event).then(function () {
        ...
        EventsTimelineView.prototype.updateDetailsPane = function (event) {
            ...
            sectorDataPromise.done(function (sectorData) {
                _this._detailsView = new EventDetailsView(event, details, sectorData, timeSpan);
                _this._timelineDetailsHeader.classList.add(_this._eventDetailsHeaderClass);
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/js/EventsTimelineView.js.map

// ImageUrlValidationHelpers.ts
//
// Copyright (C) Microsoft. All rights reserved.
//
var VisualProfiler;
(function (VisualProfiler) {
    ...
    var ImageUrlValidationHelpers = (function () {
        ...
        ImageUrlValidationHelpers.isValidImageUrl = function (url) {
            return ImageUrlValidationHelpers.IMG_DATA_URI_REGEX.test(url) || ImageUrlValidationHelpers.MS_APP_IMG_REGEX.test(url) || ImageUrlValidationHelpers.IMG_DISK_REGEX.test(url);
        };
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/js/ImageUrlValidationHelpers.js.map
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/js/ToolbarViewModel.js.map
...
/// <reference path="../Bpt.Diagnostics.Common/control.ts" />
/// <reference path="../Bpt.Diagnostics.Common/templateControl.ts" />
/// <reference path="../../Common/formattingHelpers.ts" />
/// <reference path="../VisualProfilerData.d.ts" />
...
(function (VisualProfiler) {
    ...
    var DonutChartView = (function (_super) {
        ...
        DonutChartView.prototype.onRenderSectorTooltip = function (sectorInfo, percent) {
            ...
            return Microsoft.Plugin.Resources.getString("SectorTooltipFormat", sectorInfo.name, Common.FormattingHelpers.getDecimalLocaleString(percent, false), timeStamp);
        };
        return DonutChartView;
    })(Common.Controls.Legacy.Control);
    VisualProfiler.DonutChartView = DonutChartView;
})(VisualProfiler || (VisualProfiler = {}));
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/js/DonutChartView.js.map
    ...
    var AnalyzerDataSession = (function () {
        ...
        AnalyzerDataSession.prototype.initialize = function () {
            ...
            return this._dataWarehouse.getContextService().getGlobalContext().then(function (context) {
                ...
                // Get the UIThread Id
                return _this.getThreadInfo().then(function (result) {
        ...
        AnalyzerDataSession.prototype.queryAppIntervals = function (timeRange, filter) {
            if (this._dataWarehouse) {
                ...
                var customData = {
                    task: 6 /* GetAppIntervals */.toString(),
                ...
                return this._dataWarehouse.getFilteredData(contextData, AnalyzerDataSession.TIMELINE_ANALYZER_CLASSID).then(function (result) {
        ...
        AnalyzerDataSession.prototype.getThreadInfo = function () {
            if (this._dataWarehouse) {
                var customData = {
                    task: 7 /* GetThreadInfo */.toString()
                };
                var contextData = {
                    customDomain: customData
                };
                return this._dataWarehouse.getFilteredData(contextData, AnalyzerDataSession.TIMELINE_ANALYZER_CLASSID).then(function (threadInfo) {
                    return threadInfo;
                }, function (error) {
                    throw error;
                });
        ...
        AnalyzerDataSession.prototype.getTelemetryStats = function () {
            if (this._dataWarehouse) {
                var customData = {
                    task: 8 /* GetTelemetryStats */.toString()
                };
                var contextData = {
                    customDomain: customData
                };
                return this._dataWarehouse.getFilteredData(contextData, AnalyzerDataSession.TIMELINE_ANALYZER_CLASSID).then(function (telemetryStats) {
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/js/AnalyzerDataSession.js.map
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/js/MarkEventModel.js.map
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/js/ProfilingSource.js.map
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/codeMarkerValues.js.map
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/responsivenessNotifications.js.map
...
/// <reference path="../../Common/Script/Hub/Plugin.redirect.d.ts" />
/// <reference path="../../common/trace.ts" />
/// <reference path="../common/Packager.ts" />
/// <reference path="../common/hostShell.ts" />
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/Program.js.map
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/Program.main.js.map
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/VisualProfiler.js.map
...
(function (VisualProfiler) {
    ...
    var VisualProfilerView = (function () {
        ...
        VisualProfilerView.prototype.setupAnalysisView = function (result) {
            ...
            this.eventsTimelineView.viewModel.getTelemetryStatsAndFormatForReporting().then(function (values) {
                VisualProfiler.Program.reportTelemetry("AnalysisTarget", values);
            });
        };
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/VisualProfilerView.js.map
...
//# sourceMappingURL=file:///f:/binaries/Intermediate/ClientDiagnostics/visualprofiler.csproj_1601524658/objr/x86/built/VisualProfilerView.vs.js.map
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFBF8anmlUhrd
// SIG // +onyVUyR9n8vME5DoIIVgzCCBMMwggOroAMCAQICEzMA
...
// SIG // KwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUnAlHLRJt
// SIG // 2oD0L1ZCIPuv7tit4vIwWgYKKwYBBAGCNwIBDDFMMEqg
// SIG // MIAuAFYAaQBzAHUAYQBsAFAAcgBvAGYAaQBsAGUAcgBN
// SIG // AGUAcgBnAGUAZAAuAGoAc6EWgBRodHRwOi8vbWljcm9z
// SIG // b2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQC2KTnRzJRe
// SIG // fQ5WNkf+NhMngRrlwaEpA1PSFTBUMtQQHnpxcugGpzgs
// SIG // q9KJy4YnQRHDG4ozBt0XSCsrXVKle1yS441zVnYXhgBK
// SIG // mRRE8/hrvz00dawC2NO7Psuuch+ClT3qdKOR3ahHm6+L
// SIG // GoGpFQXH+BhcjUtNPl4OAL7afMONQ/OLI12XuQzp5ftM
// SIG // DqMdqIL+ymT6t8CqTcwCGYxQayj5aebBwN/SQufCJqv+
// SIG // uH/UD25wU0iBERpJ6dHegVc/cSbKL5drAK/9Fn/9p0JM
// SIG // VHHxdASAMvEsmQzbj1yt1YmgyAv+DF3A0wbQ8HwH0L4c
// SIG // ULaKssnAgXHyiWgK2ejSQoV1oYICKDCCAiQGCSqGSIb3
// SIG // DQEJBjGCAhUwggIRAgEBMIGOMHcxCzAJBgNVBAYTAlVT
// SIG // MRMwEQYDVQQIEwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdS
// SIG // ZWRtb25kMR4wHAYDVQQKExVNaWNyb3NvZnQgQ29ycG9y
// SIG // YXRpb24xITAfBgNVBAMTGE1pY3Jvc29mdCBUaW1lLVN0
// SIG // YW1wIFBDQQITMwAAAJzu/hRVqV01UAAAAAAAnDAJBgUr
// SIG // DgMCGgUAoF0wGAYJKoZIhvcNAQkDMQsGCSqGSIb3DQEH
// SIG // ATAcBgkqhkiG9w0BCQUxDxcNMTYwOTA3MDQ0NzUzWjAj
// SIG // BgkqhkiG9w0BCQQxFgQUTud8DrJxlrbtqP2PaCPTx9fR
// SIG // CUEwDQYJKoZIhvcNAQEFBQAEggEABRofEIOLIJu6Thrz
// SIG // sKdYzXBy3m79o/pWnVuJkHyXUtziELLu/t08GN//Lj6f
// SIG // k7Vb+8byrSDWMZiYZnZEdFABxYTHBa/MPKYyTUXxOfAC
// SIG // 0eEqXORWXLqMjMzLZZ16rXUqYzx5UnfgqSw/MuEr8XeP
// SIG // uGsefn4/EGH+PQY/3Ws02HVVcwiZXg47kDyk0zXfRrQY
// SIG // V4EexZuCfpstM2lfaF5Ljn3ZsaRVCnB9fYCB6PUQ8s1t
// SIG // eVRUHMtjUqurDFS2KJFjyrE5FBotlGJyMJszilyvscPC
// SIG // Zf6OU/R0P2DJ/KEHKQih6cDwe0XQlMQYFRHXSFF+25wB
// SIG // djg9tyaPh5mCbIM05A==
