...
CREATE table SUBJECTS
    (     SUBJECTS      char(10)   constraint SUBJECTS_PK  primary key, 
     SUBJECTS_NAME varchar(100) unique,
     PULPIT       char(20)    constraint SUBJECTS_PULPIT_FK foreign key 
                         references PULPIT(PULPIT)   
    )
...
( SUBJECTS   char(10) constraint PROGRESS_SUBJECTS_FK foreign key
