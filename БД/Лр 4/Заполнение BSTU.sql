...
insert into  TEACHER    (TEACHER,  TEACHER_NAME, PULPIT )
                       values  ('КЛСНВ',    'Колесников Виталий Леонидович',  'ИСиТ');
insert into  TEACHER    (TEACHER,  TEACHER_NAME, PULPIT )
                       values  ('БРКВЧ',    'Бракович Андрей Игоревич',  'ИСиТ');
insert into  TEACHER    (TEACHER,  TEACHER_NAME, PULPIT )
                       values  ('ДТК',     'Дятко Александр Аркадьевич',  'ИСиТ');
insert into  TEACHER    (TEACHER,  TEACHER_NAME, PULPIT )
...
insert into  TEACHER    (TEACHER,  TEACHER_NAME, PULPIT )
                       values  ('АТР',      'Атрощенко Олег Александрович',  'ЛУ');                       
insert into  TEACHER    (TEACHER,  TEACHER_NAME, PULPIT )
